...
def main2():
    ...
    white = ['0x84b81987f6ca3cde2a50daca42a58a132099c731', '0xafea5b52c980bda1c5bd43dcb381a1b295213e77', '0x3dfbc47e76171a82a5121ada179c73d00b60ba22', '0x62eabbfe4a558051c473fe339a599d9e1bae9434', '0x6d1105ba1b4effb4073e99df2c8ff17ebffff0a8', '0x41ce0fe7cd60b23b78c24126f122f72686247395', '0xafab1adfb25e919d9f6ee7196f1ad0ffa93cad12', '0x0e636d680b300214cf10e3343d0eef14f642c8a4', '0x2f87201c55b4e120f64b69b3391867572bd75b01', '0xb8c7fca90863d00e033f749b81ab816608f9ef37', '0xd3adfeda41e7756151741fcb5f763f461bc4304f', '0xc7048830a7b0d67d712ffd59f879a9b8b1f48a4a', '0x29f82d09c2afd12f3c10ee49cd713331f4a7228e', '0x7d7032134d6aafeb1564720917150ff89fafce9d', '0x475021e2cbfe925beafb63084646eaa8ffe195e7', '0xed44745042ffbc012b19788ed78f8d539cd12c02', '0xca14697a2799573915884ff7860ba1c452a46fbf', '0x008de4b238bc4507c6e11ce875ae45878c08d0e9', '0x5275817b74021e97c980e95ede6bbac0d0d6f3a2', '0xc0513edb8acf4b0f42cb9ab92b2b667717e33636', '0x6119fa6c5b18be03f3b8e408c961e28239a0108c', '0xfe8fc68127e2a40f477aa406da0da3ec5a2f5a43']
    accountList02,accountList09,accountList16,accountList23 = [],[],[],[]
    fblc = open("../data/not_active_account_blacklist-2021-08-18.json",'r').read()
    f09 = open("../data/distribution-2021-08-04.json", 'r').read()
    f23 = open("../data/distribution-2021-07-28.json", 'r').read()
    f16 = open("../data/distribution-2021-08-11.json", 'r').read()
    f02 = open("../data/distribution-2021-07-21.json", 'r').read()
...
def main():
    ...
    endlst = []
    amountend = 0
    f = open("../data/origin-distribution-2021-08-18.json", 'r').read()
    fbal = open("../data/balances-2021-08-18.json", 'r').read()
    fend = open("../data/distribution-2021-08-18.json", 'r').read()
